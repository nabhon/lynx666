import '../../domain/entities/win_log.dart';
import '../../domain/entities/enums.dart';
import 'enum_extensions.dart';

/// Data model for WinLog entity
class WinLogModel extends WinLog {
  const WinLogModel({
    required super.id,
  ...
  /// Create a WinLogModel from a JSON map (Supabase response)
  factory WinLogModel.fromJson(Map<String, dynamic> json) {
    return WinLogModel(
  ...
  /// Convert WinLogModel to JSON map for Supabase
  ...
  /// Create a WinLogModel from a Supabase map
  factory WinLogModel.fromSupabase(Map<String, dynamic> data) {
    return WinLogModel.fromJson(data);
  }

  /// Convert WinLogModel to Supabase insert/update map
  ...
  /// Create a copy of this WinLogModel with updated fields
  WinLogModel copyWith({
    String? id,
  ...
  factory WinLogModel.fromEntity(WinLog entity) {
    return WinLogModel(
      id: entity.id,
  ...
  @override
  String toString() => 'WinLogModel(id: $id, criteria: $winCriteria, prize: $prizeAmount)';
}
